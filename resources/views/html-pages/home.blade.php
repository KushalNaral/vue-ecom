...
<html lang="en">
  ...
  <head>
    ...
    />
    <title>Index Dashboard - Greeny</title>
  ...
  <body>
      ...
      <div class="container">
        <div class="header-content">
          ...
          ><a href="login.html" class="header-widget" title="My Account"
            ><img src="{{asset('images/user.png')}}" alt="user" /><span>join</span></a
          >
              ...
              <ul class="navbar-list">
                <li class="navbar-item dropdown">
                  ...
                  <ul class="dropdown-position-list">
                    <li><a href="home-grid.html">Dashboard grid</a></li>
                    <li><a href="index.html">Dashboard index</a></li>
                    <li><a href="home-classic.html">Dashboard classic</a></li>
                    <li><a href="home-standard.html">Dashboard standard</a></li>
                    <li><a href="home-category.html">Dashboard category</a></li>
                  </ul>
                </li>
                            ...
                            <ul class="megamenu-list">
                              <li>
                                <a href="product-tab.html"
                                  >product single tab</a
                                >
                              </li>
                              <li>
                                <a href="product-grid.html"
                                  >product single grid</a
                                >
                              </li>
                              <li>
      ...
      <ul class="cart-list">
        <li class="cart-item">
          <div class="cart-media">
            <a href="#"><img src="{{asset('images/product/01.jpg')}}" alt="product" /></a
        ...
        <li class="cart-item">
          <div class="cart-media">
            <a href="#"><img src="{{asset('images/product/02.jpg')}}" alt="product" /></a
            ><button class="cart-delete">
              <i class="far fa-trash-alt"></i>
            </button>
          </div>
        ...
        <li class="cart-item">
          <div class="cart-media">
            <a href="#"><img src="{{asset('images/product/03.jpg')}}" alt="product" /></a
            ><button class="cart-delete">
              <i class="far fa-trash-alt"></i>
            </button>
          </div>
        ...
        <li class="cart-item">
          <div class="cart-media">
            <a href="#"><img src="{{asset('images/product/04.jpg')}}" alt="product" /></a
            ><button class="cart-delete">
              <i class="far fa-trash-alt"></i>
            </button>
          </div>
        ...
        <li class="cart-item">
          <div class="cart-media">
            <a href="#"><img src="{{asset('images/product/05.jpg')}}" alt="product" /></a
            ><button class="cart-delete">
              <i class="far fa-trash-alt"></i>
            </button>
          </div>
      ...
      <div class="nav-content">
        <div class="nav-btn">
          <a href="login.html" class="btn btn-inline"
            ><i class="fa fa-unlock-alt"></i><span>join here</span></a
          >
        </div>
    ...
    <div class="mobile-menu">
      <a href="index.html" title="Dashboard Page"
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-6 col-lg-6">
              <div class="banner-img">
                <img src="{{asset('images/dashboard/index/01.png')}}" alt="index" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="banner-part banner-2">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 col-lg-6">
              <div class="banner-img">
                <img src="{{asset('images/dashboard/index/02.png')}}" alt="index" />
              </div>
            </div>
            <div class="col-md-6 col-lg-6">
              <div class="banner-content">
        ...
        <ul class="suggest-slider slider-arrow">
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/01.jpg')}}" alt="suggest" />
              <h5>vegetables <span>34 items</span></h5></a
            >
          </li>
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/02.jpg')}}" alt="suggest" />
              <h5>fruits <span>89 items</span></h5></a
            >
          </li>
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/03.jpg')}}" alt="suggest" />
              <h5>groceries <span>45 items</span></h5></a
            >
          </li>
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/04.jpg')}}" alt="suggest" />
              <h5>dairy farm <span>83 items</span></h5></a
            >
          </li>
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/05.jpg')}}" alt="suggest" />
              <h5>sea foods <span>40 items</span></h5></a
            >
          </li>
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/06.jpg')}}" alt="suggest" />
              <h5>vegan foods <span>57 items</span></h5></a
            >
          </li>
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/07.jpg')}}" alt="suggest" />
              <h5>dry foods <span>23 items</span></h5></a
            >
          </li>
          <li>
            <a class="suggest-card" href="shop-4column.html"
              ><img src="{{asset('images/suggest/08.jpg')}}" alt="suggest" />
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/01.jpg')}}" alt="product"
                /></a>
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/02.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/03.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/04.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/05.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/06.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/07.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/08.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/09.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="{{asset('images/product/10.jpg')}}" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
    ...
    <div class="section promo-part">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="promo-img">
              <a href="#"><img src="{{asset('images/promo/dashboard/03.jpg')}}" alt="promo" /></a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="feature-card">
              <div class="feature-media">
                ...
                <button class="feature-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="feature-image" href="product-video.html"
                  ><img src="{{asset('images/product/11.jpg')}}" alt="product"
                /></a>
                <div class="feature-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="feature-card">
              <div class="feature-media">
                ...
                <button class="feature-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="feature-image" href="product-video.html"
                  ><img src="{{asset('images/product/12.jpg')}}" alt="product"
                /></a>
                <div class="feature-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="feature-card">
              <div class="feature-media">
                ...
                <button class="feature-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="feature-image" href="product-video.html"
                  ><img src="{{asset('images/product/13.jpg')}}" alt="product"
                /></a>
                <div class="feature-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="feature-card">
              <div class="feature-media">
                ...
                <button class="feature-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="feature-image" href="product-video.html"
                  ><img src="{{asset('images/product/14.jpg')}}" alt="product"
                /></a>
                <div class="feature-widget">
                  <a
                    title="Product Compare"
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 mx-auto">
            <div class="countdown-content">
              ...
              <div
                class="countdown countdown-clock"
              ...
              <a href="shop-4column.html" class="btn btn-inline"
                ><i class="fas fa-shopping-basket"></i><span>shop now</span></a
              >
            </div>
          </div>
          ...
          <div class="col-lg-5">
            <div class="countdown-img">
              <img src="{{asset('images/countdown.png')}}" alt="countdown" />
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="{{asset('images/product/15.jpg')}}" alt="product"
                    /></a>
                    <div class="product-widget">
                      <a
                        title="Product Compare"
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="{{asset('images/product/16.jpg')}}" alt="product"
                    /></a>
                    <div class="product-widget">
                      <a
                        title="Product Compare"
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="{{asset('images/product/17.jpg')}}" alt="product"
                    /></a>
                    <div class="product-widget">
                      <a
                        title="Product Compare"
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="{{asset('images/product/18.jpg')}}" alt="product"
                    /></a>
                    <div class="product-widget">
                      <a
                        title="Product Compare"
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="{{asset('images/product/19.jpg')}}" alt="product"
                    /></a>
                    <div class="product-widget">
                      <a
                        title="Product Compare"
                ...
                <div class="product-card">
                  <div class="product-media">
                    ...
                    <button class="product-wish wish">
                      <i class="fas fa-heart"></i></button
                    ><a class="product-image" href="product-video.html"
                      ><img src="{{asset('images/product/20.jpg')}}" alt="product"
                    /></a>
                    <div class="product-widget">
                      <a
                        title="Product Compare"
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6 col-lg-6 px-xl-3">
            <div class="promo-img">
              <a href="#"><img src="{{asset('images/promo/dashboard/01.jpg')}}" alt="promo" /></a>
            </div>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-6 px-xl-3">
            <div class="promo-img">
              <a href="#"><img src="{{asset('images/promo/dashboard/02.jpg')}}" alt="promo" /></a>
            </div>
          </div>
        </div>
      </div>
            ...
            <ul class="nav nav-tabs">
              <li>
                <a
                  ...
                  data-bs-toggle="tab"
                  ><i class="icofont-price"></i><span>top order</span></a
                >
              </li>
              <li>
                <a href="#top-rate" class="tab-link" data-bs-toggle="tab"
                  ><i class="icofont-star"></i><span>top rating</span></a
                >
              </li>
              <li>
                <a href="#top-disc" class="tab-link" data-bs-toggle="tab"
                  ><i class="icofont-sale-discount"></i
                  ><span>top discount</span></a
                >
              </li>
            </ul>
          </div>
    ...
    <section class="section brand-part">
      <div class="container">
        ...
        <div class="brand-slider slider-arrow">
          ...
          <div class="brand-wrap">
            <div class="brand-media">
              <img src="{{asset('images/brand/02.jpg')}}" alt="brand" />
              <div class="brand-overlay">
                <a href="brand-single.html"><i class="fas fa-link"></i></a>
              </div>
            </div>
          ...
          <div class="brand-wrap">
            <div class="brand-media">
              <img src="{{asset('images/brand/03.jpg')}}" alt="brand" />
              <div class="brand-overlay">
                <a href="brand-single.html"><i class="fas fa-link"></i></a>
              </div>
            </div>
          ...
          <div class="brand-wrap">
            <div class="brand-media">
              <img src="{{asset('images/brand/04.jpg')}}" alt="brand" />
              <div class="brand-overlay">
                <a href="brand-single.html"><i class="fas fa-link"></i></a>
              </div>
            </div>
          ...
          <div class="brand-wrap">
            <div class="brand-media">
              <img src="{{asset('images/brand/05.jpg')}}" alt="brand" />
              <div class="brand-overlay">
                <a href="brand-single.html"><i class="fas fa-link"></i></a>
              </div>
            </div>
          ...
          <div class="brand-wrap">
            <div class="brand-media">
              <img src="{{asset('images/brand/06.jpg')}}" alt="brand" />
              <div class="brand-overlay">
                <a href="brand-single.html"><i class="fas fa-link"></i></a>
              </div>
            </div>
          ...
          <div class="col-lg-12">
            <div class="section-btn-50">
              <a href="brand-list.html" class="btn btn-outline"
                ><i class="fas fa-eye"></i><span>view all brands</span></a
              >
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <div class="testimonial-slider slider-arrow">
              <div class="testimonial-card">
                ...
                <img src="{{asset('images/avatar/01.jpg')}}" alt="testimonial" />
              </div>
              <div class="testimonial-card">
                <i class="fas fa-quote-left"></i>
                <p>
                ...
                <img src="{{asset('images/avatar/02.jpg')}}" alt="testimonial" />
              </div>
              <div class="testimonial-card">
                <i class="fas fa-quote-left"></i>
                <p>
                ...
                <img src="{{asset('images/avatar/03.jpg')}}" alt="testimonial" />
              </div>
              <div class="testimonial-card">
                <i class="fas fa-quote-left"></i>
                <p>
                ...
                <img src="{{asset('images/avatar/04.jpg')}}" alt="testimonial" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <div class="blog-slider slider-arrow">
              <div class="blog-card">
                ...
                <div class="blog-content">
                  ...
                  <a class="blog-btn" href="#"
                    ><span>read more</span><i class="icofont-arrow-right"></i
                  ></a>
                </div>
              </div>
              <div class="blog-card">
              ...
              <div class="blog-card">
                <div class="blog-media">
                  <a class="blog-img" href="#"
                    ><img src="{{asset('images/blog/03')}}" alt="blog"
                  /></a>
                </div>
                <div class="blog-content">
                  <ul class="blog-meta">
              ...
              <div class="blog-card">
                <div class="blog-media">
                  <a class="blog-img" href="#"
                    ><img src="{{asset('images/blog/04')}}" alt="blog"
                  /></a>
                </div>
                <div class="blog-content">
                  <ul class="blog-meta">
          ...
          <div class="col-lg-12">
            <div class="section-btn-25">
              <a href="blog-grid.html" class="btn btn-outline"
                ><i class="fas fa-eye"></i><span>view all blog</span></a
              >
            </div>
          </div>
        </div>
    ...
    <section
      class="news-part"
      style="background: url(images/newsletter')}}) no-repeat center"
    >
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="footer-widget">
              ...
              <div class="footer-app">
                <a href="#"
                  ><img src="{{asset('images/google-store.png')}}" alt="google" /></a
          ...
          <div class="col-12">
            <div class="footer-bottom">
              ...
              <div class="footer-card">
                <a href="#"
                  ><img src="{{asset('images/payment/jpg/01')}}" alt="payment" /></a
                ><a href="#"
                  ><img src="{{asset('images/payment/jpg/02')}}" alt="payment" /></a
                ><a href="#"
                  ><img src="{{asset('images/payment/jpg/03')}}" alt="payment" /></a
                ><a href="#"
